...
**User Story:** As a player, I want to play a first come first serve quiz game about a particular movie as a team.

#### Acceptance Criteria
1. WHEN player join the game room THEN there is points based quiz game
2. WHEN game starts THEN then quistions are asked about the selected movie
3. WHEN options are given THEN whoever goes first can answer the question in 2 sec
4. WHEN player answers correctly THEN they get the point and next question comes
5. WHEN player does not answer under 2 sec, then the answer control is taken from them and others can choose to answer
6. WHEN quetsions and choices are given THEN these should be generated by the AI
7. THE questions should not be very easy and general and should require very deep and specific knowledge about the movie in quesion i-e movie scenes, movie items, asset, characters, crew